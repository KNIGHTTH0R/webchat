...
if ($_POST['file']) { $room = $_POST['file']; } else { $room = 'error.txt'; }

$cr = $room;// 'chat.txt'; ///////////////// chatroom name
...
//////////////////////////////////////////////	
	 ...
	 case('send'):
		...
		if(($message) != "\n"){
		 ...
		 // Write log.
		 fwrite(fopen('./rooms/'.$cr, 'a'), "<div class=\"nick\" onclick=\"mesgTo('".$nickname."');\" style=\"color:#".$nickname.";\">". $nickname . "</div>  &rarr; <div class=\"mesg\">" . $message = str_replace("\n", " ", $message) . "</div><br>\n"); 
	 }
		 break;
